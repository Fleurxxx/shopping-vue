    ...
    <div>
      <header class="w">
        <div class="w-box">
          <div class="nav-logo">
            <div class="logo-mimi">
              <img class="logo-img1" src="../assets/images/vectorgraph/天猫8.png">
            </div>
            <h1 @click="changePage(-1)">
              <router-link to="/" title="天猫商城官网">天猫商城</router-link>
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
              <el-autocomplete class="input-deep"
                placeholder="请输入商品信息"
                suffix-icon="Search"
                icon="search"
                v-model="input"
              ...
              <router-link to="/home/goods"><a v-on:click="changePage(2)">全部商品</a></router-link>
              <router-link to="/home/favorite"><a @click="changePage(4)">收藏夹</a></router-link>
  ...
  .w-box {
    ...
    h1 {
      ...
      > a {
        ...
        margin-left: 17px;
        margin-top: 12px;
        background: url('../assets/images/vectorgraph/天猫9.png') no-repeat 50%;
    ...
    .user {
      ...
      > a {
        ...
        &:before {
          ...
          top: 0;
          @include wh(20px);
          background: url('../assets/static/images/account-icon@2x.32d87deb02b3d1c3cc5bcff0c26314ac.png') -155px 0;
    ...
    .shop {
      ...
      > a {
        ...
        &:before {
          ...
          @include wh(30px, 100%);
          content: " ";
          background: url('../assets/static/images/account-icon@2x.32d87deb02b3d1c3cc5bcff0c26314ac.png') 0 -22px;
          background-size: 240px 107px;
  ...
  .nav-user-wrapper {
    ...
    .nav-user-list {
      ...
      &:before {
        position: absolute;
        content: " ";
        background: url('../assets/static/images/account-icon@2x.32d87deb02b3d1c3cc5bcff0c26314ac.png') no-repeat -49px -43px;
        background-size: 240px 107px;
        @include wh(20px, 8px);
        top: -8px;
        margin-left: -10px;
